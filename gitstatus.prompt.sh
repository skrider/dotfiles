...
function gitstatus_prompt_update() {
  ...
  local      clean=$'\001\e[32m\002'  # green foreground
  local  untracked=$'\001\e[31m\002'  # teal foreground
  local   modified=$'\001\e[36m\002'  # yellow foreground
  local conflicted=$'\001\e[34m\002'  # red foreground
